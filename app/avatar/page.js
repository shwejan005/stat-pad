...
const names = [
  ...
  'Orion', 'Nyx', 'Juno', 'Vega', 'Lyra', 'Zephyr', 'Onyx', 'Draco',
  'Ember', 'Sol', 'Cosmo', 'Indigo', 'Novae', 'Storm', 'Sage'
];
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-7 gap-4 items-center">
            <div className="col-span-2 text-xl font-semibold text-purple-400">Styles</div>
            <div className="col-span-3 text-xl font-semibold text-purple-400 text-center">Preview</div>
            <div className="col-span-2  text-xl font-semibold text-purple-400 gap-2 pt-4">Characters</div>
          </div>

          {/* Top Grid: Style + Preview */}
